...
try:
from src.agents.mainpc.sd_config import DEVICE_INDEX, SAMPLE_RATE
...
from src.agents.mainpc.tts_cache import get_cached_audio, add_to_cache, play_cached_audio, clear_cache
        has_cache_system = True
