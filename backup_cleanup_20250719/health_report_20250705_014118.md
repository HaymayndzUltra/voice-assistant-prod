...
[94m[DEBUG][0m Error checking HTTP health of SystemDigitalTwin: HTTPConnectionPool(host='localhost', port=7121): Max retries exceeded with url: /health (Caused by NewConnectionError('<urllib3.connection.HTTPConnection object at 0x7fdb583d4af0>: Failed to establish a new connection: [Errno 111] Connection refused'))
[[91m![0m] SystemDigitalTwin - Error checking HTTP health: HTTPConnectionPool(host='localhost', port=7121): Max retries exceeded with url: /health (Caused by NewConnectionError('<urllib3.connection.HTTPConnection object at 0x7fdb583d4af0>: Failed to establish a new connection: [Errno 111] Connection refused'))
...
[1mMVS Health Status Report - 2025-07-05 01:41:18[0m
...
SystemDigitalTwin              [⚠️] [91mERROR     [0m Error checking HTTP health: HTTPConnectionPool(host='localhost', port=7121): Max retries exceeded with url: /health (Caused by NewConnectionError('<urllib3.connection.HTTPConnection object at 0x7fdb583d4af0>: Failed to establish a new connection: [Errno 111] Connection refused'))
--------------------------------------------------------------------------------
...
Health report saved to /home/haymayndz/AI_System_Monorepo/main_pc_code/NEWMUSTFOLLOW/logs/health_report_20250705_014118.json
