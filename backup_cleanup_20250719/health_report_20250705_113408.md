...
[94m[DEBUG][0m Using health_check_port from params for SystemDigitalTwin: 7121
...
[94m[DEBUG][0m Using health_check_port from params for ModelManagerAgent: 5571
...
[94m[DEBUG][0m Using health_check_port from params for CoordinatorAgent: 26003
[94m[DEBUG][0m Checking CoordinatorAgent on port 26003, expecting status=ok, type=zmq_req
[94m[DEBUG][0m Connecting to tcp://127.0.0.1:26003
[94m[DEBUG][0m Sending health check request to CoordinatorAgent: {'action': 'health_check'}
[94m[DEBUG][0m Using health_check_port from params for ChainOfThoughtAgent: 5613
...
[94m[DEBUG][0m Using health_check_port from params for GoTToTAgent: 7001
...
[94m[DEBUG][0m Using health_check_port from params for SelfTrainingOrchestrator: 5645
...
[94m[DEBUG][0m Using health_check_port from params for EmotionEngine: 5591
...
[94m[DEBUG][0m Using health_check_port from params for AudioCapture: 6576
...
[94m[DEBUG][0m Error checking HTTP health of SystemDigitalTwin: HTTPConnectionPool(host='localhost', port=7121): Max retries exceeded with url: /health (Caused by NewConnectionError('<urllib3.connection.HTTPConnection object at 0x7fb5f02fd180>: Failed to establish a new connection: [Errno 111] Connection refused'))
[[91m![0m] SystemDigitalTwin - Error checking HTTP health: HTTPConnectionPool(host='localhost', port=7121): Max retries exceeded with url: /health (Caused by NewConnectionError('<urllib3.connection.HTTPConnection object at 0x7fb5f02fd180>: Failed to establish a new connection: [Errno 111] Connection refused'))
...
[1mMVS Health Status Report - 2025-07-05 11:34:08[0m
...
CoordinatorAgent               [⌛] [93mTIMEOUT   [0m No response from agent on port 26003
...
SystemDigitalTwin              [⚠️] [91mERROR     [0m Error checking HTTP health: HTTPConnectionPool(host='localhost', port=7121): Max retries exceeded with url: /health (Caused by NewConnectionError('<urllib3.connection.HTTPConnection object at 0x7fb5f02fd180>: Failed to establish a new connection: [Errno 111] Connection refused'))
--------------------------------------------------------------------------------
...
Health report saved to /home/haymayndz/AI_System_Monorepo/main_pc_code/NEWMUSTFOLLOW/logs/health_report_20250705_113408.json
