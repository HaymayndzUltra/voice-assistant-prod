...
# Custom API Contract for learning_manager
from common.api.contract import APIContract, APIMessage, APIResponse, APIVersion, Status
from typing import Dict, Any

class LearningManagerContract(APIContract):
    """Custom API contract for learning_manager operations"""
...
def register_learning_manager_contract(processor):
    """Register learning_manager contract with API processor"""
    contract = LearningManagerContract()
    endpoints = ["/learning_manager", "/api/v1/learning_manager"]
