...
# WP-10 Access Control Integration for goal_manager
...
class GoalManagerAccessControlIntegration:
    """Access control integration for goal_manager"""
    ...
    def _setup_access_rules(self):
        ...
        self.access_control.add_rule(AccessRule(
            name="goal_manager_throttle_high_freq",
            priority=100,
            conditions={
        ...
        # Allow admin bypass
        self.access_control.add_rule(AccessRule(
            name="goal_manager_admin_bypass",
            priority=1,
            conditions={
                "roles": ["admin", "system"]
            },
        ...
        self.access_control.add_rule(AccessRule(
            name="goal_manager_block_suspicious",
            priority=75,
            conditions={
                "path": {
    ...
    def _setup_rate_limits(self):
        ...
        self.access_control.rate_limiter.add_rule(RateLimitRule(
            name="goal_manager_api_requests",
        ...
        self.access_control.rate_limiter.add_rule(RateLimitRule(
            name="goal_manager_auth_attempts",
            limit_type=RateLimitType.REQUESTS_PER_MINUTE,
            max_requests=5,
            time_window=60,
            burst_allowance=0
        ...
        # Hourly limits
        self.access_control.rate_limiter.add_rule(RateLimitRule(
            name="goal_manager_hourly_requests",
    ...
    @protect_endpoint(
        rate_limit_rule="goal_manager_api_requests",
        require_auth=True,
...
# Example usage:
# access_control = GoalManagerAccessControlIntegration()
# 
