...
# NATS Error Bus Integration Example for system_digital_twin
...
class SystemDigitalTwinWithErrorBus:
    """
    Enhanced system_digital_twin with NATS error bus integration
    """
    
    def __init__(self):
        self.agent_name = "system_digital_twin"
        self.error_bus = None
...
async def main():
    agent = SystemDigitalTwinWithErrorBus()
