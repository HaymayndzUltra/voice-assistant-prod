...
# NATS Error Bus Integration Example for streaming_speech_recognition
...
class StreamingSpeechRecognitionWithErrorBus:
    """
    Enhanced streaming_speech_recognition with NATS error bus integration
    """
    
    def __init__(self):
        self.agent_name = "streaming_speech_recognition"
        self.error_bus = None
...
async def main():
    agent = StreamingSpeechRecognitionWithErrorBus()
