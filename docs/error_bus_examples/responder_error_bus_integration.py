...
# NATS Error Bus Integration Example for responder
...
class ResponderWithErrorBus:
    """
    Enhanced responder with NATS error bus integration
    """
