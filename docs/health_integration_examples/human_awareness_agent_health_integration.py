...
# Health Integration Example for human_awareness_agent
...
class HumanAwarenessAgent(UnifiedHealthMixin):
    """
    Enhanced human_awareness_agent with unified health monitoring
    """
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.add_custom_metric("agent_type", "human_awareness_agent")
