...
# Health Integration Example for model_manager_agent
...
class ModelManagerAgent(UnifiedHealthMixin):
    """
    Enhanced model_manager_agent with unified health monitoring
    """
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.add_custom_metric("agent_type", "model_manager_agent")
