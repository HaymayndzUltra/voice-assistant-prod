...
# WP-07 Bulkhead Integration for zmq_pool
...
class ZmqPoolBulkheads:
    """Bulkhead isolation for zmq_pool"""
...
@bulkhead(
    name="zmq_pool_heavy_computation",
    max_concurrent=3,
    timeout=120.0,
    isolation_strategy=IsolationStrategy.THREAD_POOL
)
