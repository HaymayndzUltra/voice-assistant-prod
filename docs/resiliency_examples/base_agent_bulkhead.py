...
# WP-07 Bulkhead Integration for base_agent
...
class BaseAgentBulkheads:
    """Bulkhead isolation for base_agent"""
...
@bulkhead(
    name="base_agent_heavy_computation",
    max_concurrent=3,
    timeout=120.0,
    isolation_strategy=IsolationStrategy.THREAD_POOL
)
...
@bulkhead(
    name="base_agent_external_calls",
    max_concurrent=15,
    timeout=30.0
)
