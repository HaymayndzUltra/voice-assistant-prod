...
# WP-08 Profiling Integration for voice_profiling_agent
...
class VoiceProfilingAgentProfilingIntegration:
    """Profiling integration for voice_profiling_agent"""
    
    def __init__(self):
        self.profiler = get_profiler()
    
    @profile_time(name="voice_profiling_agent_main_operation")
    async def main_operation(self, data):
        """Main operation with time profiling"""
        return await self.process_data(data)
    
    @profile_memory(name="voice_profiling_agent_memory_intensive")
    ...
    @profile_cpu(name="voice_profiling_agent_cpu_intensive")
    ...
    @profile_all(name="voice_profiling_agent_comprehensive")
    ...
    def get_performance_report(self):
        ...
        main_op_summary = self.profiler.get_profile_summary("voice_profiling_agent_main_operation")
        
        return {
            "agent": "voice_profiling_agent",
...
# Example usage:
# profiling = VoiceProfilingAgentProfilingIntegration()
