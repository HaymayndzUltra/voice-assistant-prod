...
# WP-08 Caching Integration for streaming_speech_recognition
...
class StreamingSpeechRecognitionCacheIntegration:
    """Caching integration for streaming_speech_recognition"""
    
    def __init__(self):
        # Configure different cache types
        self.response_cache = get_cache(
            "streaming_speech_recognition_responses",
            CacheConfig(
        ...
        self.computation_cache = get_cache(
            "streaming_speech_recognition_computations",
            CacheConfig(
    ...
    @cached(cache_name="streaming_speech_recognition_responses", ttl=300.0)
    ...
    @cached(cache_name="streaming_speech_recognition_computations", ttl=3600.0)
    ...
    @cache_invalidate(cache_name="streaming_speech_recognition_responses", pattern="user_")
...
# Example usage:
# cache_integration = StreamingSpeechRecognitionCacheIntegration()
