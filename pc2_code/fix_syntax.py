...
def fix_unterminated_string():
    ...
    backup_path = 'd:/DISKARTE/Voice Assistant/phi_adapter.py.syntax_backup'
    ...
    # Ultra-simplified fix approach: rebuild the file with minimal required elements
    try:
        minimal_file = """import os
import zmq
import time
import json
import logging
...
"""
        ...
        with open(input_path, 'w', encoding='utf-8') as f:
            f.write(minimal_file)
            
        print("Fixed phi_adapter.py with a clean, minimal implementation")
        return True
...
if __name__ == "__main__":
    if fix_unterminated_string():
        print("SYNTAX ERRORS FIXED! The adapter should now start correctly.")
    else:
        print("Failed to fix syntax errors. Please check the backup and fix manually.")
