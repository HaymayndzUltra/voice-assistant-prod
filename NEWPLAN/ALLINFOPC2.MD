...
- **GoalManager**: Unified agent for goal decomposition, task assignment, and swarm coordination. Handles all high-level goal management and distributed task execution for PC2 as well.