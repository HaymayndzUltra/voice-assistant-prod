...
GROUP: Language & Translation Services
REASONING: This is a Tier 2 agent that coordinates language detection and translation services. It implements a multi-tier fallback system with PC2 translation, local translation, Google Translate, and emergency translation options. The agent handles language detection, caching, and performance monitoring to optimize translation quality and latency.
RESOURCES: Moderate CPU usage, no direct GPU requirements. Manages multiple translation services and implements sophisticated caching and fallback mechanisms.
DEPENDENCIES: ZMQ for communication, fastText (optional) for language identification, GoogleTranslator as a fallback, connects to TagaBERTa service and PC2 translation services.
