#!/bin/bash
# =============================================================================
# MAINPC CORE PLATFORM FINAL FIXED STARTUP SCRIPT
# =============================================================================

set -e

echo "🚀 Starting MainPC Core Platform Container (FINAL FIXED)..."
...
# Function to start agent in background with proper environment and parameters
start_agent() {
    local agent_name=$1
    ...
    # Pass redis_host and redis_port as kwargs to BaseAgent
