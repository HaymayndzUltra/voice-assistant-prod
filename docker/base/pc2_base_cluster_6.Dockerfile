# PC2 Base Image: cluster_6
# Auto-generated by PC2 dependency clustering
# Dependencies: 0 packages

FROM python:3.10-slim-bullseye AS pc2_base_cluster_6
...
COPY docker/base/requirements_cluster_6.txt /tmp/cluster_deps.txt
