# PC2 Base Image: cluster_1
# Auto-generated by PC2 dependency clustering
# Dependencies: 2 packages

FROM python:3.10-slim-bullseye AS pc2_base_cluster_1
...
COPY docker/base/requirements_cluster_1.txt /tmp/cluster_deps.txt
