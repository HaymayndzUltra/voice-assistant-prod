# PC2 Base Image: cluster_10
# Auto-generated by PC2 dependency clustering
# Dependencies: 3 packages

FROM python:3.10-slim-bullseye AS pc2_base_cluster_10
...
COPY docker/base/requirements_cluster_10.txt /tmp/cluster_deps.txt
