# PC2 Base Image: cluster_5
# Auto-generated by PC2 dependency clustering
# Dependencies: 0 packages

FROM python:3.10-slim-bullseye AS pc2_base_cluster_5
...
COPY docker/base/requirements_cluster_5.txt /tmp/cluster_deps.txt
