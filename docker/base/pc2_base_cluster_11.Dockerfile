# PC2 Base Image: cluster_11
# Auto-generated by PC2 dependency clustering
# Dependencies: 0 packages

FROM python:3.10-slim-bullseye AS pc2_base_cluster_11
...
COPY docker/base/requirements_cluster_11.txt /tmp/cluster_deps.txt
