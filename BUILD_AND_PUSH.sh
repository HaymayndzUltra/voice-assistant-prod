...
echo ""
echo "Health check endpoints (per plan.md §F):"
echo "  curl http://localhost:8212/health  # ModelOpsCoordinator (port 7212/8212)"
echo "  curl http://localhost:6560/health  # AffectiveProcessingCenter (port 5560/6560)"
echo "  curl http://localhost:6557/health  # RealTimeAudioPipeline (port 5557/6557)"
echo ""
echo "All ports match plan.md line 117-119 exactly!"