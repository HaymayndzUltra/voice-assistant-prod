...
log_filename = f'logs/pc2_zmq_health_report_{current_time}.log'
        ...
        try:
            ...
            if isinstance(response, dict):
                ...
                if (service_status == expected_status or 
                    ...
                    result["error"] = f"Response did not match expected health check data"
            else:
                result["status"] = "error"
...
def generate_health_report(results):
    ...
    table.field_names = ["Service ID", "Display Name", "ZMQ Address", "Status", "Latency", "Error"]
    table.align = "l"
