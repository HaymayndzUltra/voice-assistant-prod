...
class FixedStreamingTranslation(BaseAgent):
    def __init__(self, port: int = 5584, **kwargs):
        ...
        self.cache = TranslationCache(max_size=CACHE_SIZE, ttl=CACHE_TTL) if ENABLE_CACHING else None
    ...
    def _process_translation_request(self, request: Dict):
        ...
        try:
            ...
            if success and ENABLE_CACHING and self.cache:
    ...
    def get_health_status(self) -> Dict:
        """Get health status for BaseAgent compatibility."""
        return {
